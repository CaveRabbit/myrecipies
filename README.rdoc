...
- Restrict actions like create receip, edit recipe and like feature to logged in chefs only
- Restricting editing of recipes by chefs who created the recipe